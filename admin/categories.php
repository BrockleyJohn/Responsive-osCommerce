...
// P2C-SORT-EDIT-1
	if (!tep_db_num_rows(tep_db_query("SHOW COLUMNS FROM products_to_categories LIKE 'products_sort_order'"))) {
		tep_db_query('ALTER TABLE products_to_categories ADD products_sort_order INT( 11 ) NOT NULL default 0');
	}
