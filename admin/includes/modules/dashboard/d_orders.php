...
*/
  ...
  class d_orders {
    ...
    function getOutput() {
      ...
      $orders_query = tep_db_query("select o.orders_id, o.customers_name, date_format(greatest(o.date_purchased, ifnull(o.last_modified, 0)), '%Y-%m-%d') as date_last_modified, s.orders_status_name, ot.text as order_total from " . TABLE_ORDERS . " o, " . TABLE_ORDERS_TOTAL . " ot, " . TABLE_ORDERS_STATUS . " s where o.orders_id = ot.orders_id and ot.class = 'ot_total' and o.orders_status = s.orders_status_id and s.language_id = '" . (int)$languages_id . "' order by date_last_modified desc limit 6");
